 ...
 * @since  0.0.1
 */
class ReferenceModelPresDate extends JModelAdmin
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getTable($type = 'PresDate', $prefix = 'ReferenceTable', $config = array())
	{
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState(
			'com_reference.edit.presdate.data',
			array()
		);
