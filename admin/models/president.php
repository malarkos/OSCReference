 ...
 * @since  0.0.1
 */
class ReferenceModelPresident extends JModelAdmin
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getTable($type = 'President', $prefix = 'ReferenceTable', $config = array())
	{
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState(
			'com_reference.edit.president.data',
			array()
		);
