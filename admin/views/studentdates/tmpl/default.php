...
?>
<form action="index.php?option=com_reference&view=studentdates" method="post" id="adminForm" name="adminForm">
		...
		<tbody>
			<?php if (!empty($this->items)) : ?>
				<?php foreach ($this->items as $i => $row) :
					$link = JRoute::_('index.php?option=com_reference&task=studentdate.edit&id=' . $row->id);
				?>
					<tr>
						...
						<td>
							<?php echo JHtml::_('grid.id', $i, $row->id); ?>
                                                ...
                                                <td>
                                                    <a href="<?php echo $link; ?>" title="<?php echo JText::_('COM_REFERENCE_EDIT_STUDENTDATE'); ?>">
								<?php echo $row->Year; ?>
                                                    </a>
						</td>
						<td>
